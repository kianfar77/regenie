...
############
# Make in debug mode. Turn optimization.
CXX           = g++
CXXFLAGS      = -ggdb -O0 -Wall -ffast-math -std=c++11
EFILE         = regenie
CFLAGS        =
...
INC          += -I${PGEN_PATH} -I${PGEN_PATH}/include/ -I${BGEN_PATH} -I${BGEN_PATH}/genfile/include/ -I${BGEN_PATH}/3rd_party/zstd-1.1.0/lib -I${BGEN_PATH}/db/include/ -I${BGEN_PATH}/3rd_party/sqlite3 -I./external_libs/ -I${BGEN_PATH}/3rd_party/boost_1_55_0
